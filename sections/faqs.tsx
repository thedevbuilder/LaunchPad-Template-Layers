...
export default function Faqs() {
    ...
    return <section className="mt-40 font-poppins mx-auto px-4 max-w-5xl">
        <div>
            ...
            <h2 className="font-medium text-5xl text-center mt-6 max-w-xl mx-auto">Questions? We've got <span className="text-lime-400">answers</span></h2>
              <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                 {faqs.map(({question,answer},index)=> <Faq selectedIndex={selectedIndex} setSelectedIndex={setSelectIndex} index={index} key={index} answer={answer} question={question}/>)}
           </div>
        </div>
    </section>;
}
